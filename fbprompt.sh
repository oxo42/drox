...
source /usr/facebook/ops/rc/scm-prompt
...
jobscount() {
    ...
    echo -n "\[$COLOR_GREEN\]${running}\[$COLOR_RESET\]/\[$COLOR_RED\]${stopped}\[$COLOR_RESET\]"
}

PS1="\[\033[0;33m\]$(hostname -s) \w\[$COLOR_RESET\]\$(${dvcs_function})\[$COLOR_RESET\] \n\[\033[0;37m\]\A\[\033[0;0m\] $(jobscount) \\$ "
